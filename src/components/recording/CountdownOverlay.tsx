...
const SVG_DATA = {
  3: {
    ...
    reveal:
      'M140.4,128.98s108.36-31.19,119.07-18.49-112.27,108.18-112.27,108.18c0,0,109.05-57.12,106.31-13.11s-11.85,55.62-50.27,81.96-95.71-18.58-95.71-18.58'
  },
  2: {
    viewBox: '0 0 400 400',
    content:
    ...
    reveal:
      'M101.13,175.28s151.41-81.92,157.41-47.95-88.45,107.68-109.44,116.62-101.6,15.22-88.95,37.73,241.99-63.58,245.18-30.2-52.63,49.56-52.63,49.56'
  },
  1: {
    viewBox: '0 0 400 400',
    content:
    ...
    reveal:
      'M157.98,120.56s79.2-25.46,98.72-11.54c15.81,11.27-37.38,56.86-49.92,81.03-16.29,31.38-20.31,46.95-31.37,56.7s-92.16,82.72-61.04,62.68c45.64-29.39,69.04-35.31,91.17-37.13s82.39,7.74,82.39,7.74'
  }
};
...
function AnimatedNumber({ number, isExiting = false }: AnimatedNumberProps) {
  ...
  const maskId = `mask-${number}-${id}`;
  const filterId = `blur-${number}-${id}`;
